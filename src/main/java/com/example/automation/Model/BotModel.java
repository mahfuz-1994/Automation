...
@NamedStoredProcedureQuery(
	      name = BotModel.NamedQuery_BotNameStoreProcedure,
	      procedureName = "get_TblBotName"
	      )
@NamedStoredProcedureQuery(
	      name = BotModel.NamedQuery_BotAllStoreProcedure,
...
@NamedStoredProcedureQuery(
		name = BotModel.NamedQuery_BotInsertStoreProcedure,
...
public class BotModel {
	...
	public static final String NamedQuery_BotNameStoreProcedure = "BotNameStoreProcedure";
	public static final String NamedQuery_BotAllStoreProcedure = "BotAllStoreProcedure";
	public static final String NamedQuery_BotInsertStoreProcedure = "BotInsertStoreProcedure";
